...
void handleRoot() {
  ...
  message += String(F("</td></tr><tr><td>Power</td><td>"));
  message += relais_power;
  message += String(F(" W</td></tr><tr><td>Total</td><td>"));
  message += relais_kwh;
  message += String(F(" kWh</td></tr><tr><td>Ontime remaining</td><td>"));
  message += relais_on;
